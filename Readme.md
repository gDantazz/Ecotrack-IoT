...
## 🔗 Links Importantes do Challenge
> Ao avaliar, verifique o acesso do vídeo e os anexos abaixo.

- 🎥 **Vídeo Pitch (Apresentação):** `[Cole seu link do YouTube Aqui]`
- 📄 **Documentação Completa de Arquitetura de IA:** [Acessar Documento](./Docs/IA_Architecture.md)